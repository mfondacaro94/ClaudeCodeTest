"""Evaluate models and generate metrics, confusion matrices, and feature importance."""
...
def get_test_data():
    ...
    y_test = df["p1_win"].iloc[val_end:].astype(int)
...
def main():
    ...
    metrics = {
        ...
        "p1_win_rate": round(float(y_test.mean()), 4),
        "n_models": len(models),
    }
    ...
    report = classification_report(y_test, ensemble_pred, target_names=["P2 Win", "P1 Win"])
    logger.info(f"\n{report}")
